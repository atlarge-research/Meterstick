...
traces.append(go.Scatter(x=[0,300],y=[50,50], mode='lines', showlegend=True,xaxis='x', yaxis='y2', line=dict(color='black', dash='dash',width=2),name='Overloaded Point'))
traces.append(go.Scatter(x=[0,300],y=[50,50], mode='lines', showlegend=False,xaxis='x2', yaxis='y2', line=dict(color='black', dash='dash',width=2),name='Overloaded Point'))
traces.append(go.Scatter(x=[0,300],y=[50,50], mode='lines', showlegend=False,xaxis='x3', yaxis='y2', line=dict(color='black', dash='dash',width=2),name='Overloaded Point'))
...
with open(str(output_dir.joinpath("multi_baseline_tick_and_cpu.pdf")), "wb") as f:
